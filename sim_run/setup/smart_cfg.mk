...
#	@cd ./work && make -s clean && make -s all CPU_ARCH_FLAG_0=c906fd  ENDIAN_MODE=little-endian CASENAME=ISA_INT FILE=C906_INT_SMOKE >& ISA_INT_build.case.log 
	@cd ./work && make -s clean && make -s all CPU_ARCH_FLAG_0=cute318  ENDIAN_MODE=little-endian CASENAME=ISA_INT FILE=CUTE_INT_SMOKE >& ISA_INT_build.case.log 
...
#	@cd ./work && make  clean && make  all CPU_ARCH_FLAG_0=c906fd  ENDIAN_MODE=little-endian CASENAME=coremark FILE=core_main >& coremark_build.case.log 
	@cd ./work && make  clean && make  all CPU_ARCH_FLAG_0=cute318  ENDIAN_MODE=little-endian CASENAME=coremark FILE=core_main >& coremark_build.case.log 
...
helloworld_build:
	@cp ./tests/cases/helloworld/* ./work
	@find ./tests/lib/ -maxdepth 1 -type f -exec cp {} ./work/ \; 
	@cp ./tests/lib/clib/* ./work 
	@cp ./tests/lib/newlib_wrap/* ./work
	@cd ./work && make -s clean && make -s all CPU_ARCH_FLAG_0=cute318  ENDIAN_MODE=little-endian CASENAME=helloworld FILE=helloworld >& helloworld_build.case.log 

timer_test_build:
	@cp ./tests/cases/timer_test/* ./work
	@find ./tests/lib/ -maxdepth 1 -type f -exec cp {} ./work/ \; 
	@cp ./tests/lib/clib/* ./work 
	@cp ./tests/lib/newlib_wrap/* ./work
	@cd ./work && make -s clean && make -s all CPU_ARCH_FLAG_0=cute318  ENDIAN_MODE=little-endian CASENAME=timer_test FILE=timer_test >& timer_test_build.case.log 


uart_tx_build:
	@cp ./tests/cases/uart_tx/* ./work
	@find ./tests/lib/ -maxdepth 1 -type f -exec cp {} ./work/ \; 
	@cp ./tests/lib/clib/* ./work 
	@cp ./tests/lib/newlib_wrap/* ./work
	@cd ./work && make -s clean && make -s all CPU_ARCH_FLAG_0=c906fd  ENDIAN_MODE=little-endian CASENAME=uart_tx FILE=uart_tx >& uart_tx_build.case.log 

spi_test_build:
	@cp ./tests/cases/spi_test/* ./work
	@find ./tests/lib/ -maxdepth 1 -type f -exec cp {} ./work/ \; 
	@cp ./tests/lib/clib/* ./work 
	@cp ./tests/lib/newlib_wrap/* ./work
	@cd ./work && make -s clean && make -s all CPU_ARCH_FLAG_0=c906fd  ENDIAN_MODE=little-endian CASENAME=spi FILE=spi_test >& spi_test_build.case.log 
