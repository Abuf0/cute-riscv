...
.global INST15_1_HALF
INST15_1_HALF:
    fcvt.w.h        x15, f0 , rne
    li              x1 , 0xffffffffffffffff
    bne             x1 , x15, RESULTFAIL
.global INST15_2_HALF
INST15_2_HALF:
    fcvt.w.h        x15, f0 , rtz
    li              x1 , 0xffffffffffffffff
    bne             x1 , x15, RESULTFAIL
.global INST15_3_HALF
INST15_3_HALF:
    fcvt.w.h        x15, f0 , rdn
    li              x1 , 0xffffffffffffffff
    bne             x1 , x15, RESULTFAIL
.global INST15_4_HALF
INST15_4_HALF:
    fcvt.w.h        x15, f0 , rup
    li              x1 , 0xffffffffffffffff
    bne             x1 , x15, RESULTFAIL
.global INST15_5_HALF
INST15_5_HALF:
    fcvt.w.h        x15, f0 , rmm
    li              x1 , 0xffffffffffffffff
    bne             x1 , x15, RESULTFAIL
...
INST16_HALF:
    ...
    FPUEXCHK        0x00000021, x4 , x3 
    bne             x3 , x4 , FLAGCFAIL
.global INST16_1_HALF
INST16_1_HALF:
    fcvt.wu.h       x15, f0 , rne
    li              x1 , 0x00000002
    bne             x1 , x15, RESULTFAIL
.global INST16_2_HALF
INST16_2_HALF:
    fcvt.wu.h       x15, f0 , rtz
    li              x1 , 0x00000001
    bne             x1 , x15, RESULTFAIL
.global INST16_3_HALF
INST16_3_HALF:
    fcvt.wu.h       x15, f0 , rdn
    li              x1 , 0x00000001
    bne             x1 , x15, RESULTFAIL
.global INST16_4_HALF
INST16_4_HALF:
    fcvt.wu.h       x15, f0 , rup
    li              x1 , 0x00000002
    bne             x1 , x15, RESULTFAIL
.global INST16_5_HALF
INST16_5_HALF:
...
INST17_HALF:
    ...
    bne             x3 , x4 , FLAGCFAIL
    FPUMOVH         f0 , 0xbc00, x4 
.global INST17_1_HALF
INST17_1_HALF:
    fcvt.l.h        x15, f0 , rne
    bne             x1 , x15, RESULTFAIL
    FPUMOVH         f0 , 0xbc00, x4 
.global INST17_2_HALF
INST17_2_HALF:
    fcvt.l.h        x15, f0 , rtz
    bne             x1 , x15, RESULTFAIL
    FPUMOVH         f0 , 0xbc00, x4 
.global INST17_3_HALF
INST17_3_HALF:
    fcvt.l.h        x15, f0 , rdn
    li              x1 , 0xffffffffffffffff
    bne             x1 , x15, RESULTFAIL
    FPUMOVH         f0 , 0xbc00, x4 
.global INST17_4_HALF
INST17_4_HALF:
    fcvt.l.h        x15, f0 , rup
    bne             x1 , x15, RESULTFAIL
    FPUMOVH         f0 , 0xbc00, x4 
.global INST17_5_HALF
INST17_5_HALF:
    fcvt.l.h        x15, f0 , rmm
    li              x1 , 0xffffffffffffffff
    bne             x1 , x15, RESULTFAIL
...
INST220:
    ...
    li              x2 , 0x200000
    li              x11, 0x200000
    li              x12, 0x80000000ffffffff
    li              x13, 0xf1f1f1f170000000
    sd              x12, 8  ( x11)
    sd              x13, 16 ( x11)
.global CFLDSP_0
CFLDSP_0:
    c.fldsp         f20, 0x8( x2 )
    FPUSCHECKD      f20, 0x80000000ffffffff, x3 , x4 
    bne             x3 , x4 , FAIL
.global CFLDSP_1
CFLDSP_1:
    c.fldsp         f20, 0x10( x2 )
    FPUSCHECKD      f20, 0xf1f1f1f170000000, x3 , x4 
    bne             x3 , x4 , FAIL
.global CFSDSP_0
CFSDSP_0:
    FPUMOVD         f21, 0x4444444433333333, x1 
    c.fsdsp         f21, 0x10( x2 )
    ld              x20, 0x10( x2 )
    li              x1 , 0x4444444433333333
    bne             x20, x1 , FAIL
    li              x10, 0x300000
    li              x11, 0xffffffff
    li              x12, 0x7
...
CFLD_0:
    c.fld           f10, 0  ( x10)
    FPUSCHECKD      f10, 0x7ffffffff, x3 , x4 
    bne             x3 , x4 , FAIL
.global CFSD_0
CFSD_0:
    FPUMOVS         f10, 0x66666666, x1 
    c.fsd           f10, 0  ( x10)
    ld              x11, 0  ( x10)
    li              x12, 0xffffffff66666666
    bne             x11, x12, FAIL
    j __exit           
.global FAIL
FAIL:
